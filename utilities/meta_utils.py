...
@DeprecationWarning
def update_parameters(model: torch.nn.Module, loss, params=None, step_size=0.5, first_order=False):
    """Update of the meta-parameters with one step of gradient descent on the
    loss function.
    Parameters
    ----------
    model :
        Model instance (torch.nn.Module)
    ...
    """
    if params is None:
        params = OrderedDict(model.named_meta_parameters())
