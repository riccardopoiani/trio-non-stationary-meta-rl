...
from configs import gauss_rl2_arguments, gauss_ts_arguments, gauss_bayes_arguments
...
def get_meta_test(algo, gp_list_sequences, sw_size, prior_sequences, init_prior_sequences,
    ...
    if algo == "rl2":
        algo_args = gauss_rl2_arguments.get_args(rest_args)
        ...
        algo_args = gauss_bayes_arguments.get_args(rest_args)
        ...
        algo_args = gauss_ts_arguments.get_args(rest_args)
