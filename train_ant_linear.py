...
def main():
    ...
    folder = "result/antlinear/"
    env_name = "antlinear-v0"
    ...
    task_generator = AntTaskGeneratorAdvanced(n_frictions=8,
    ...
    prior_std_min = [friction_var_min_rnd ** (1/2) for _ in range(latent_dim)]
    ...
    if args.algo == 'rl2':
        obs_shape = (111 + 8 + 1 + 1,)  # 2 obs_shape + 2 action_shape + 1 reward + 1 done
