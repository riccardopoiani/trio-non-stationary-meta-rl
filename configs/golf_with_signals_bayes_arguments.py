...
"""
taskset -c 0-43 python3.5 train_mini_golf.py --algo ours --folder oursnew --training-iter 25000 --gamma 0.99 --num-processes 32 --num-test-processes 1 --eval-interval 300 --vae-smart 1 --ppo-lr 0.00005 --clip-param 0.1 --init-vae-steps 5000 --hidden-size 16 --decay-kld-rate 1 --num-steps 40 --use-elu 0 --use-rms-rew 1 --seed 131
"""
...
def get_args(rest_args):
    ...
    # PPO-parameters
    parser.add_argument('--num-steps', type=int, default=40, help="number of steps before updating")
    ...
    parser.add_argument('--state-extractor-dim', default=12, type=int)
    parser.add_argument('--latent-extractor-dim', default=3, type=int)
    parser.add_argument('--uncertainty-extractor-dim', default=1, type=int)
    ...
    parser.add_argument('--init-vae-steps', default=5000, type=int, help="initial number of inference training step")
    ...
    parser.add_argument('--decay-kld-rate', type=float, default=1,
    ...
    parser.add_argument('--vae-prior-emb-dim', type=int, default=4,
                        help="Dimension of the embedding layer concerning the prior in VAE network")
    parser.add_argument('--vae-gru-dim', type=int, default=64, help="Number of units in the GRU dim. of VAE network")
    ...
    # General settings
    parser.add_argument('--training-iter', default=25000, type=int, help="number of training iterations")
