...
def get_args(rest_args):
    ...
    # RL parameters
    parser.add_argument('--gamma', default=1.0, type=float, help="RL discount factor")

    # PPO-parameters
    parser.add_argument('--num-steps', type=int, default=30, help="number of steps before updating")
    ...
    parser.add_argument('--hidden-size', default=8, type=int, help="number of hidden neurons in agent policy")
    ...
    parser.add_argument('--decay-kld-rate', type=float, default=0.01,
                        help="decay parameter of the KLD loss used in inference training")
    parser.add_argument('--vae-max-steps', type=int, default=60,
    ...
    # General settings
    parser.add_argument('--training-iter', default=15000, type=int, help="number of training iterations")
    parser.add_argument('--eval-interval', type=int, default=500, help="evaluate agent every x iteration")
